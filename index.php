...
if ($save[1] != "") {
  ...
  if ($handle) {
    while (false !== ($file = readdir($handle)))
    {
      ...
      if ($file == $save[1])
      {
          $code_save = file_get_contents('save/' . $save[1]);
      }
    }
    closedir($handle);
  }
...
<html lang="en">
    ...
    <body>		
        ...
        <div id="title_bar">
          <div id="title"><a href="http://maverick.td.utfpr.edu.br/code">UTFPR <span title="Web Run Code">WRC</span></a></div>

            <div class="drop"><span>Arquivos</span>
                <div>
                    <div class="clickable"><a data-bind="click: php_info">phpinfo()</a></div>
                    <?php if ($save[1] == "") { echo '<div class="clickable"><a data-bind="click: save">Salvar</a></div>'; }?>
                    <div class="clickable"><a data-bind="click: remote_import">Importar...</a></div>
                    <div class="clickable"><a data-bind="click: download_file">Download...</a></div>
                </div>
            </div>
            <div class="drop"><span>Opções</span>
                <div>
                    <div class="checkbox" data-bind="my_checkbox: settings.colorize, click: change_setting" data-label="Cor"></div>
            ...
            <div class="drop"><span>Temas</span>
            ...
            </div><div class="drop drop_help_window" data-bind="event: { mouseover: load_contributors }">
                <span><i class="fa fa-question"></i></span>
                        <div id="help_window">
                                <div style="padding: 10px;">
                                        <p>
                                                 Código baseado no Run PHP Code do Website Duck LLC<br />
                                        </p>

                                        <a class="button" href="https://github.com/websiteduck/Run-PHP-Code"><i class="fa fa-github"></i> Run PHP Code</a><br>
                                </div>

                                <div class="subdrop with_icon" style="text-align: left;">
                                        <i class="fa fa-users"></i> Contribuições
                                        <div>
                ...
                <div id="button_container">
                        <button class="button" type="button" data-bind="click: clear"><i class="fa fa-eraser"></i> &nbsp; Limpar</button>
                        <button class="button" type="button" title="Run (Ctrl+Enter)" data-bind="click: run">RODAR &nbsp; <i class="fa fa-play"></i></button>
                </div>
